{if !$_controller->isAjax}
    <div class="row toggle-column js-toggle-column">
        <div class="col-sm-9 toggle-column__main js-ajaxwrapper" id="ajaxwrapper">
        {/if}
        ...
        <div class="col-sm-3 toggle-column__alt _sticky datatable-header">
            ...
            <div class="datatable-filters">
                <span class="toggle-column__toggler js-toggle-column__toggler">></span>
                {$filters}
            </div>
        </div>
    </div>
